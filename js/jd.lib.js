(function(){if(!$("#_JD_ALLSORT").length){return};var navigations=[{e:"book",c:"图书",d:1},{e:"electronic",c:"家用电器",d:0},{e:"digital",c:"手机数码",d:0},{e:"computer",c:"电脑办公",d:0},{e:"home",c:"家居生活",d:0},{e:"clothing",c:"服饰鞋帽",d:0},{e:"beauty",c:"个护化妆",d:0},{e:"watch",c:"钟表首饰",d:0},{e:"sports",c:"运动健康",d:0},{e:"baby",c:"母婴玩具",d:0},{e:"food",c:"食品饮料",d:0},{e:"music",c:"音乐",d:2,t:"k|音乐|1"},{e:"movie",c:"影视",d:2,t:"k|影视|2"},{e:"education",c:"教育音像",d:2},{e:"jipiao",c:"机票",d:3},{e:"recharge",c:"充值",d:3},{e:"lottery",c:"彩票",d:4}],domain={0:"http://www.360buy.com/{0}.html",1:"http://book.360buy.com/",2:"http://mvd.360buy.com/{0}.html",3:"http://www.360buy.com/{0}/",4:"http://caipiao.360buy.com/"};$.each(navigations,function(i){if(document.body.id==navigations[i]["e"]&&!$("#nav-extra").prev().hasClass("curr")){$("#nav-extra").before("<div class='curr'><a href='"+domain[navigations[i]["d"]].replace("{0}",navigations[i]["e"])+"'>"+navigations[i]["c"]+"</a></div>");}});if(!$("#_JD_ALLSORT").attr("load")){$("#_JD_ALLSORT").html("<div class='item fore'><span><h3><a href='http://book.360buy.com/'>图书</a>、<a href='http://mvd.360buy.com/music.html'>音乐</a>、<a href='http://mvd.360buy.com/movie.html'>影视</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/electronic.html'>家用电器、汽车用品</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/digital.html'>手机数码</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/computer.html'>电脑、办公</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/home.html'>家居、厨具、家装</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/clothing.html'>服饰鞋帽</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/beauty.html'>个护化妆</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/watch.html'>礼品箱包、钟表首饰</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/sports.html'>运动健康</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/baby.html'>母婴、玩具、乐器</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://www.360buy.com/food.html'>食品饮料、保健品</a></h3><s></s></span></div><div class='item'><span><h3><a href='http://caipiao.360buy.com/'>彩票</a>、<a href='http://www.360buy.com/jipiao/'>机票</a>、<a href='http://www.360buy.com/recharge/'>充值</a>、<a href='http://www.360buy.com/products/4938-4943-000.html'>票务</a></h3><s></s></span></div><div class='extra'><a href='http://www.360buy.com/allSort.aspx'>全部商品分类</a></div>");}$(".allsort").hoverForIE6({current:"allsorthover",delay:200});})();
/*livequery*/
...
drawLinks();});};
/*getSortData*/
var category={getDataUrl:"http://www.360buy.com/ajaxservice.aspx?stype=SortJson",getBrandsUrl:"http://www.360buy.com/lishi.aspx?callback=category.getBrandService&id=a,915,925^b,916,926^c,917,927^d,918,928^e,919,929^f,920,930^g,921,931^h,922,932^i,923,933^j,924,934^k,2096,2097^l,3512,3513",template:["<div class='{0}' id='{2}'>{1}</div>","<span><h3>{0}</h3><s></s></span>","<div class='i-mc'><div onclick=\"$(this).parent().parent().removeClass('hover')\" class=\"close\"></div><div class='subitem'>{0}</div><div id='JD_sort_{1}' class='fr'><div class='iloading'>正在加载中，请稍候...</div></div></div>","<dl class='{0}'><dt>{1}</dt><dd>{2}</dd></dl>","<em>{0}</em>","<a href='{0}'{2}>{1}</a>","<div class='extra'><a href='http://www.360buy.com/allSort.aspx'>全部商品分类</a></div>","<ul>{0}</ul>","<li>·{0}</li>"],getString:function(a,d){if(!typeof d=="object"&&!d.length){return;}var e,c;for(var b=0;b<d.length;b++){c=new RegExp("\\{"+b+"\\}");e=e?e.replace(c,d[b]):a.replace(c,d[b]);}return e;},getUrl:function(a){if(/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(a)){return a;}else{return"http://www.360buy.com/products/"+a+".html";}},getData:function(){$.getJSONP(this.getDataUrl,category.getDataService);},getDataService:function(u){$("#_JD_ALLSORT").attr("load","1");var E=u.data,B=this.getString,s=this.getUrl,C=this.template,h=[];for(var A=0;A<E.length;A++){var g=(A==0)?"item fore":"item",m=(E[A].t=="l")?"virtual":"",D,f=(!E[A].u)?E[A].n:B(C[5],[E[A].u,E[A].n,""]),e=[],d=[],t=E[A].i,o,n;for(var w=0;w<t.length;w++){o=t[w].i;var l=[],k=(t[w].u)?B(C[5],[s(t[w].u),t[w].n,""]):t[w].n;for(var v=0;v<o.length;v++){n=o[v].split("|");D=(n[0].indexOf("qianxun.com")!=-1)?" target='_blank'":"";var j=B(C[5],[s(n[0]),n[1],D]);l.push(B(C[4],[j]));}d.push(B(C[3],["",k,l.join("")]));}e.push(B(C[1],[f]));e.push(B(C[2],[d.join(""),E[A].t]));h.push(B(C[0],[g,e.join(""),m]));}h.push(C[6]);$("#_JD_ALLSORT").html(h.join(""));$(".allsort .item").hoverForIE6({delay:150});this.getBrands();},getBrands:function(){$.getJSONP(this.getBrandsUrl,category.getBrandService);},getBrandService:function(t){$("#_JD_ALLSORT").attr("load","2");var h=t.data,f=this.getString,m=this.getUrl,r=this.template;for(var q=0;q<h.length;q++){var e=h[q]["b"],d=h[q]["p"],g=h[q]["id"],i=[],p=[],o=[],l;if(e.length>0){for(var n=0;n<e.length;n++){l=f(r[5],[e[n]["u"],e[n]["n"],""]);p.push(f(r[4],[l]));}var j=(g=="k"||g=="l")?"brands brands-book":"brands",s=(g=="k")?"推荐品牌出版商":(g=="l")?"推荐产品":"推荐品牌";i.push(f(r[3],[j,s,p.join("")]));}else{i.push(f(r[0],["norecode","暂无推荐！",""]));}if(d.length>0){for(var k=0;k<d.length;k++){l=f(r[5],[d[k]["u"],d[k]["n"],""]);o.push(f(r[8],[l]));}o=f(r[7],[o.join("")]);i.push(f(r[3],["promotion","促销活动",o]));}else{i.push(f(r[0],["norecode","暂无促销活动！",""]));}$("#JD_sort_"+g).html(i.join(""));}},init:function(){var a=this;if($("#_JD_ALLSORT").length==0&&$("#o-search").length!=0){a.getBrands();return;}$("#_JD_ALLSORT").one("mouseover",function(){if(!$("#_JD_ALLSORT").attr("load")){a.getData();}else{if($("#_JD_ALLSORT").attr("load")==1){a.getBrands();}else{return;}}});}};category.init();
/*jdThickbox*/
...
/*search_plug*/
var $o=(function(regionType){var StringUtil={};StringUtil.replace=function(sTemplate,oJson){return sTemplate.replace(/#{(.*?)}/g,function(){var sWord=arguments[1];if("undefined"!=typeof(oJson[sWord])){return oJson[sWord]}else{return arguments[0]}})};String.prototype.trim=function(){return this.replace(/^\s*(.*?)\s*$/,"$1")};var NORMAL_ITEM_T='<li id="d_#{id}" title="#{title}" onclick="$o.clickItem(this)" onmouseover="$o.mouseOverItem(this)" onmouseout="$o.mouseOutItem(this)"><div>#{keyword}</div></li>';var CATEGORY_ITEM_T='<div id="d_#{id}" title="#{title}" cid="#{cid}" onclick="$o.clickItem(this)" onmouseover="$o.mouseOverItem(this)" onmouseout="$o.mouseOutItem(this)">\u5728<strong>#{cname}</strong>\u5206\u7c7b\u4e2d\u641c\u7d22</div>';var CATEGORY_CONTAINER_T='<li class="tie-sort"><div id="d_#{id}" class="fore" title="#{title}" onclick="$o.clickItem(this)" onmouseover="$o.mouseOverItem(this)" onmouseout="$o.mouseOutItem(this)">#{keyword}</div>#{categorys}</li>';if("number"==typeof(regionType)&&1==regionType){CATEGORY_ITEM_T='<dd id="d_#{id}" title="#{title}" cid="#{cid}" onclick="$o.clickItem(this)" onmouseover="$o.mouseOverItem(this)" onmouseout="$o.mouseOutItem(this)">\u5728<strong>#{cname}</strong>\u5206\u7c7b\u4e2d\u641c\u7d22</dd>';CATEGORY_CONTAINER_T='<li class="tie-sort"><dl><dt><div id="d_#{id}" class="fore" title="#{title}" onclick="$o.clickItem(this)" onmouseover="$o.mouseOverItem(this)" onmouseout="$o.mouseOutItem(this)">#{keyword}</div></dt>#{categorys}</dl></li>'}var HOST="search.360buy.com";var URL_KS_T="http://"+HOST+"/ks?keyword=#{keyword}&callback=?";var URL_SEARCH_T="http://"+HOST+"/Search?keyword=#{keyword}";var BG_COLOR="#FFFF99";var BG_COLOR_NULL="#FFF";var oInputBoxN=$("#key");var oTipBoxN=$("#tie");function SearchBox(){this.length=0;this.index=-1;this.needCreatedItem=false}SearchBox.prototype.init=function(){this.length=0;this.index=-1;this.needCreatedItem=false};SearchBox.prototype.hideTip=function(){this.init();oTipBoxN.html("").hide()};SearchBox.prototype.clickItem=function(oItemN){var sCid=oItemN.getAttribute("cid");if(null!=sCid&&""!=sCid){search.cid=sCid}oInputBoxN.val(oItemN.getAttribute("title"));search("key")};SearchBox.prototype.mouseOverItem=function(oItemN){var iIndex=parseInt(oItemN.id.split("_")[1]);if(iIndex!=this.index){if(-1!=this.index){$("#d_"+this.index).css("background-color",BG_COLOR_NULL)}this.index=iIndex}oItemN.style.backgroundColor=BG_COLOR;this.needCreatedItem=true};SearchBox.prototype.mouseOutItem=function(oItemN){oItemN.style.backgroundColor=BG_COLOR_NULL;this.needCreatedItem=false};SearchBox.prototype.moveUp=function(){var oSelf=this;if(oSelf.length>0){oSelf.index-=1;if(oSelf.index<0){oSelf.index=oSelf.length-1}var iIndex=oSelf.index;var iPostIndex=(iIndex==oSelf.length-1?0:iIndex+1);var oNode=$("#d_"+iIndex);var oPostNode=$("#d_"+iPostIndex);oSelf.selectItemNode(oNode,oPostNode)}};SearchBox.prototype.moveDown=function(){var oSelf=this;if(oSelf.length>0){oSelf.index=($o.index+1)%$o.length;var iIndex=oSelf.index;var iPreIndex=(0===iIndex?$o.length-1:iIndex-1);var oNode=$("#d_"+iIndex);var oPreNode=$("#d_"+iPreIndex);oSelf.selectItemNode(oNode,oPreNode)}};SearchBox.prototype.selectItemNode=function(oNode,oRelNode){if(oNode.length>0){oNode.css("background-color",BG_COLOR);oInputBoxN.val(oNode.attr("title"));var sCid=oNode.attr("cid");if(null!=sCid&&""!=sCid){search.cid=sCid}else{search.cid=null;}}if(oRelNode.length>0&&oNode.attr("id")!==oRelNode.attr("id")){oRelNode.css("background-color",BG_COLOR_NULL)}};SearchBox.prototype.keyup=function(event){var oSelf=this;var oEvent=event;if(null!=window.event&&"object"==typeof(window.event)){oEvent=window.event}if(0==oInputBoxN.length){oInputBoxN=$("#key")}if(0==oTipBoxN.length){oTipBoxN=$("tie")}var sKeyword=oInputBoxN.val().trim();if(""==sKeyword){oTipBoxN.html("").hide();return}var iKeyCode=oEvent.keyCode;switch(iKeyCode){case 38:oSelf.moveUp();break;case 40:oSelf.moveDown();break;case 13:case 37:case 39:break;case 27:oSelf.hideTip();break;default:sKeyword=encodeURIComponent(sKeyword);var sUrlKs=StringUtil.replace(URL_KS_T,{keyword:sKeyword});$.getJSON(sUrlKs,function(json){oSelf.onloadItems(json)})}};SearchBox.prototype.onloadItems=function(json){var iLen=json.length;if(0==iLen){return}var oSelf=this;oSelf.init();var html="";var sCategoryHtml="";var sCategoryItems="";for(var i=0,j=0;i<iLen;i++,j++){var oItem=json[i];if("number"==typeof(oItem.cid)){if("string"!=typeof(oItem.cname)){continue}if(""==sCategoryHtml){sCategoryHtml=StringUtil.replace(CATEGORY_CONTAINER_T,{id:j,title:oItem.keyword,keyword:oItem.keyword});j+=1}var sTmp=StringUtil.replace(CATEGORY_ITEM_T,{id:j,title:oItem.keyword,cid:oItem.cid,cname:oItem.cname});sCategoryItems+=sTmp}else{var sTmp=StringUtil.replace(NORMAL_ITEM_T,{id:j,title:oItem.keyword,keyword:oItem.keyword});html+=sTmp}}if(""!=sCategoryHtml){sCategoryHtml=StringUtil.replace(sCategoryHtml,{categorys:sCategoryItems});html=sCategoryHtml+html;oSelf.length=iLen+1}else{oSelf.length=iLen}if(""!=html){html+='<li class="close"><a onclick="$o.hideTip()" href="javascript:void(0)">\u5173\u95ed</a></li>';oTipBoxN.html(html).show()}else{oTipBoxN.html("").hide()}};var oSearchBox=new SearchBox();oInputBoxN.keyup(function(event){oSearchBox.keyup(event)});oInputBoxN.blur(function(){if(!oSearchBox.needCreatedItem){oSearchBox.hideTip()}});return oSearchBox})();
/* friend */
...
/*getrecent*/
var jdRecent={element:$("#recent ul"),jsurl:"http://www.360buy.com/lishiset.aspx?callback=jdRecent.setData&id=",cookiename:"_recent",list:$.cookie("_recent"),url:location.href,init:function(){var _matchStr=this.url.match(/\/(\d{6}).html/);var _id=(_matchStr!=null&&_matchStr[0].indexOf("html")!=-1)?_matchStr[1]:"";if(!this.list||this.list==null||this.list==""){if(_id==""){return this.getData(0);}else{this.list=_id;}}else{if(_id==""||this.list.indexOf(_id)!=-1){this.list=this.list;}else{if(this.list.split(".").length>=10){this.list=this.list.replace(/.\d+$/,"");}this.list=_id+"."+this.list;}}$.cookie(this.cookiename,this.list,{expires:7,path:"/",domain:"www.360buy.com",secure:false});this.getData(this.list);},clear:function(){$.cookie(this.cookiename,"",{expires:7,path:"/",domain:"www.360buy.com",secure:false});},getData:function(list){if(list==0){this.element.html("<li><div class='norecode'>暂无记录!</div></li>");return;}var rec=list.split(".");for(i in rec){if (i==0){this.element.empty()};$.getJSONP(this.jsurl+rec[i],this.setData);}},setData:function(result){this.element.append("<li><div class='p-img'><a href='"+result.url+"'><img src='"+result.img+"' /></a></div><div class='p-name'><a href='"+result.url+"'>"+decodeURIComponent(result.name)+"</a></div></li>");}};$("#clearRec").click(function(){jdRecent.clear();jdRecent.getData(0);});mlazyload({defObj:"#recent",defHeight:50,fn:function(){if (jdRecent.element.length==1){jdRecent.init();}}});
/*jdModelCallCenter#20110126*/
var jdModelCallCenter={settings:{clstag1:0,clstag2:0},tbClose:function(){if($(".thickbox").length!=0){jdThickBoxclose()}},login:function(){this.tbClose();var _this=this;var userAgent=navigator.userAgent.toLowerCase(),flag=(userAgent.match(/ucweb/i)=="ucweb"||userAgent.match(/rv:1.2.3.4/i)=="rv:1.2.3.4");if (flag){location.href="https://passport.360buy.com/new/login.aspx?ReturnUrl="+escape(location.href);return;}setTimeout(function(){$.jdThickBox({type:"iframe",title:"您尚未登录",source:"http://passport.360buy.com/new/LoginFrame.aspx?clstag1="+_this.settings.clstag1+"&clstag2="+_this.settings.clstag2+"&r="+Math.random(),width:450,height:360,_title:"thicktitler",_close:"thickcloser",_con:"thickconr"})},20)},regist:function(){this.tbClose();var _this=this;setTimeout(function(){$.jdThickBox({type:"iframe",title:"您尚未登录",source:"http://passport.360buy.com/new/registPersonalFrame.aspx?clstag1="+_this.settings.clstag1+"&clstag2="+_this.settings.clstag2+"&r="+Math.random(),width:450,height:500,_title:"thicktitler",_close:"thickcloser",_con:"thickconr"})},20)},init:function(){var _this=this;$.getJSON("http://passport.360buy.com/new/loginwebservice.aspx?callback=?",{method:"GetHello"},function(result){_this.tbClose();if(result&&result.info!=""){$("#shortcut .fore1").html(result.info)}_this.settings.fn()})}};
/*login#20110126*/
...
/*doAttention*/
$.extend(jdModelCallCenter,{doAttention:function(productId){var serviceUrl="http://t.360buy.com/regard/follow.action?callback=?";$.login({modal:true,complete:function(result){if(result!=null&&result.IsAuthenticated!=null&&result.IsAuthenticated){if(productId>0){$.getJSON(serviceUrl,{goodId:productId},function(result){if(result.code!=null){var width=388,height=(result.code=="success")?300:100,countdown=(result.code=="success")?false:6;$.jdThickBox({type:"iframe",source:"http://t.360buy.com/subscriber/jumpSubPage.action?code="+result.code+"&pid="+productId+"&t="+Math.random(),width:width,height:height,title:"提示",_box:"attboxr",_con:"attconr",_countdown:countdown})}})}}}})}});
/*btn-coll*/
$(".btn-coll").livequery("click",function(){var current=$(this);var productId=parseInt(current.attr("id").replace("coll",""));$.extend(jdModelCallCenter.settings,{clstag1:"login|keycount|5|3",clstag2:"login|keycount|5|4",id:productId,fn:function(){jdModelCallCenter.doAttention(this.id)}});jdModelCallCenter.settings.fn()});
/*
	@ModificationDate:2011/12/01
*/