...
namespace com.surfkj.small.DAL
{
    ...
    public partial class ManagerDAL
    {
        ...
        public com.surfkj.small.Model.Manager GetModel(int ID)
        {
            ...
            com.surfkj.small.Model.Manager model = new com.surfkj.small.Model.Manager();
        ...
        public com.surfkj.small.Model.Manager verifyLogin(string userName, string passWord)
        {
            StringBuilder strSql = new StringBuilder();
