<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGoodType.aspx.cs" Inherits="webmag_Goods_AddGoodType" %>
...
<body>
    ...
    <div>
        <form action="SaveGoodType.aspx?action=add" method="post" id="example" onsubmit="return verifySubmit();">
        <table width="100%" class="addTable" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="text" name="goodType" id="goodType"  />
                </td>
            </tr>
             <tr>
                <td class="leftTitle">
                ...
                <td colspan="3">
                    <select name="parent">
                           ...
                           <% for(int i=0;i< exist.Count;i++){ %>
                                <option value="<%= exist[i].ID %>#<%=exist[i].Tlevel %>"  ><%=exist[i].typeName %></option>                                
                            <%} %>
                     </select> 
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <textarea name="memo" cols="25" rows="3"></textarea>
                </td>
            </tr>
            <tr>
