<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGoodTypeAttribute.aspx.cs" Inherits="webmag_Goods_AddGoodTypeAttribute" %>
...
<body>
    <div>
        <form action="SaveGoodTypeAttribute.aspx?action=add" method="post" id="example" onsubmit="return verifySubmit();">
