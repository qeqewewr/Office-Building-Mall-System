<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateAttribute.aspx.cs" Inherits="webmag_Goods_UpdateAttribute" %>
...
<body>
    <div>
        <form action="SaveAttribute.aspx?action=edit&id=<%=attribute.ID %>" method="post" id="example" onsubmit="return verifySubmit();">
        <table width="100%" class="addTable" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            ...
            <tr>
                ...
                <td colspan="3"> 
                    <input type="text" name="attributeName" id="attributeName" value="<%= attribute.AttributeName %>" />
                </td>
            </tr> 
            <tr>
