<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateGoods.aspx.cs" Inherits="webmag_Goods_UpdateGoods" %> 
...
<body>
    ...
    <div>
        <form action="SaveGoods.aspx?action=edit&id=<%= entity.ID %>" method="post" id="example" onsubmit="return verifySubmit();">
        <table width="100%" class="addTable" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="goodName" id="goodName" value="<%=entity.goodName %>"  />
                </td>
                <td class="leftTitle">
                    <font color="#cc0033">*</font>商品货号
                </td>
                <td colspan="3">
                    <input type="text" name="goodNO" id="goodNO" value="<%=entity.goodNO %>"  />
                </td>
            </tr> 
            <tr>
                <td class="leftTitle">
                ...
                <td colspan="3"> 
                     <select id="goodType" name="goodType"> 
                         <% for(int i=0;i< exist.Count;i++){ %>
                                <option value="<%= exist[i].ID %>" <%if(entity.goodType==exist[i].ID) {%>selected<%} %>  ><%=exist[i].typeName %></option>                                
                            <%} %>
                        </select>
                </td> 
            </tr>
            <tr>
                ...
                <td colspan="3"> 
                    <input type="text" name="goodBrand" id="goodBrand"  value="<%=entity.goodBrand %>" />
                </td> 
            </tr>
            <tr>
                <td class="leftTitle">
                ...
                <td colspan="3"> 
                    <input type="text" name="goodManufacture" id="goodManufacture"  value="<%=entity.goodManufacture %>"  />
                </td> 
            </tr>
            <tr>
                <td class="leftTitle">
                ...
                <td colspan="3"> 
                    <input type="text" name="goodOrg" id="goodOrg"  value="<%=entity.goodOrg %>"  />
                </td> 
            </tr>
            <tr>
                <td class="leftTitle">
                ...
                <td> 
                    <input type="text" name="goodKg" id="goodKg" value="<%=entity.goodKg %>"  />
                </td> 
                <td class="leftTitle">
                   净重
                </td>
                <td> 
                    <input type="text" name="goodNetKg" id="goodNetKg"  value="<%=entity.goodNetKg %>"  />
                </td>
            </tr>
            <tr>
                <td class="leftTitle">
                ...
                <td> 
                    <input type="text" name="goodColor" id="goodColor"  value="<%=entity.goodColor %>"  />
                </td> 
                <td class="leftTitle">
                   尺寸
                </td>
                <td> 
                    <input type="text" name="goodSize" id="goodSize"  value="<%=entity.goodSize %>"  />
                </td>
            </tr>
            <tr>
                <td class="leftTitle">
                ...
                <td> 
                    <input type="text" name="goodSpecifications" id="goodSpecifications"  value="<%=entity.goodSpecifications %>"   />
                </td> 
                <td class="leftTitle">
                   材质
                </td>
                <td> 
                    <input type="text" name="goodMaterial" id="goodMaterial"  value="<%=entity.goodMaterial %>"  />
                </td>
            </tr>
            <tr>
                <td class="leftTitle">
                ...
                <td> 
                    <input type="text" name="goodPrice" id="goodPrice" value="<%=entity.goodPrice %>" onChange="isNumValue(this)" />
                </td> 
                <td class="leftTitle">
                   <font color="#cc0033">*</font>光大价
                </td>
                <td> 
                    <input type="text" name="goodPromotion" id="goodPromotion" <%if(entity.goodPromotion > -1){ %> value="<%=entity.goodPromotion %>" <%} %>   onChange="isNumValue(this)"/>
                </td>
            </tr>
            <tr>
                <td class="leftTitle">
                ...
                <td> 
                    <input type="checkbox" name="goodRecommand" id="goodRecommand" <%if(entity.goodRecommand == "on"){ %> checked <%} %>   />
                </td> 
                <td class="leftTitle">
                   库存数
                </td>
                <td> 
                     <input type="text" name="goodStock" id="goodStock" value="<%=entity.goodStock %>"   />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                     <textarea id="goodMemo" name="goodMemo" cols="100" rows="8"
								style="width: 100%; height: 600px; visibility: hidden;"><%=entity.goodMemo%></textarea>
                </td>
<%--                                <td colspan="3">
                     <textarea id="goodMemo" name="goodMemo"
								style="width: 100%; height: 200px; visibility: hidden;"><%=entity.goodMemo%></textarea>
                </td>--%>
            </tr> 
             <tr>
