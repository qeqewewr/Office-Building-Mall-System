<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListOrder.aspx.cs" Inherits="webmag_Order_ListOrder" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body> 
    ...
    <div class="queryArea"  style="width:100%">
            <form action="ListOrder.aspx?pageno=1" name="searchForm"
				...
				<fieldset>
					...
					<span>订单编号查询：<input type="text" name="lookByName" id="lookByName" title="请输入订单编号"
						value="<%=keyword %>" 
        ...
        <div>
			<table class="resultTable">
				...
				<tr class="topTitle" align="center">
                    ...
                    <td align="center">成交总金额</td>
                    <td align="center">订单状态</td>
					<td align="center" colspan="2">操 作</td>
				</tr> 

              <form name="pageControlForm" action="ChangePage.aspx?page=<%= pageno %>" method="post"
                      ...
                      float totalFinalMoney = 0; %>
				        ...
				        <tr onMouseOver="this.style.backgroundColor='#f3f3f3';return true;"
                            ...
                            <%
                                ...
                                {
                                    totalFinalMoney = totalFinalMoney + orderDetailList[j].finalAmount;
                                }
                             %>
                             <%= totalFinalMoney%>
                            </td>
                            <%--<td title="<%= orderList[i].finalAmount %>"><%= orderList[i].finalAmount%></td>--%>
                            <td title="<%= orderList[i].orderStatus %>"><%= Constants.orderStatus(orderList[i].orderStatus)%></td>
							
							<td>
                                <input type="button"
								value="" class="viewBtn" title="查看"
								onclick="window.location.href='ViewOrder.aspx?id=<%= orderList[i].ID%>&pageno=<%= pageno %>'">
						    </td>
						</tr>
				<%} %>
