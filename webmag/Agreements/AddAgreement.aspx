<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAgreement.aspx.cs" Inherits="webmag_Agreements_AddAgreement" %>
...
<head id="Head1" runat="server">
	...
	<script>
	    ...
	    function verifySubmit() {
	        ...
	        if (confirm("确定要提交申请吗？\n注意：提交之后不能更改申请")) {
	            if ($(".uploadifyProgress").length > 0) {
	                if (confirm("你已经选择了附件,但是没有上传，确定要提交?")) {
	                    return true;
	                } else {
	                    return false;
	                }
...
<body>
    <div>
        <form action="SaveAgreements.aspx" method="post" id="example" onsubmit="return verifySubmit();">
